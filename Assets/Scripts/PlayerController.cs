...
public class PlayerController : MonoBehaviour {
    ...
    void Update() {
        ...
        // else if (Input.GetKeyDown(KeyCode.D)) {
        //     if (frontRight) {
        //         rb.AddForceAtPosition(transform.up * Time.deltaTime * 30, paddles[0].transform.position, ForceMode2D.Impulse);
        //     }
        //     else {
        //         rb.AddForceAtPosition(transform.up * Time.deltaTime * 30, paddles[1].transform.position, ForceMode2D.Impulse);
        //     }
        // }
        //
